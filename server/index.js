...
const { reviewEndpoints } = require("./endpoints/review");
const { deliverablesEndpoints } = require("./endpoints/deliverables");
const { securityEndpoints } = require("./endpoints/security");
const { verificationEndpoints } = require("./endpoints/verification");
const { checkpointsEndpoints } = require("./endpoints/checkpoints");
...
reviewEndpoints(apiRouter);
deliverablesEndpoints(apiRouter);
securityEndpoints(apiRouter);
verificationEndpoints(apiRouter);
checkpointsEndpoints(apiRouter);
