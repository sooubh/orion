const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Sovereign AI works seamlessly with local and on-premise LLM providers (Ollama, LMStudio, LocalAI, etc.).",
    },
    userSetup: {
      title: "User Setup",
    ...
    data: {
      ...
      description:
        "Sovereign AI is committed to total privacy, local data isolation, and air-gap integrity.",
      settingsHint:
    ...
    survey: {
      ...
      useCase: "What will you use Sovereign AI for?",
      useCaseWork: "For work",
      useCasePersonal: "For personal use",
      useCaseOther: "Other",
      comment: "How did you hear about Sovereign AI?",
      commentPlaceholder:
