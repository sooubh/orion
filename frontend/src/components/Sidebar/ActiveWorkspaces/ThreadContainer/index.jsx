...
function NewThreadButton({ workspace }) {
  ...
  return (
    <button
      onClick={onClick}
      className="w-full relative flex h-[40px] items-center border-none hover:bg-[var(--theme-sidebar-thread-selected)] light:hover:bg-slate-300 light:hover:bg-theme-sidebar-subitem-hover rounded-lg"
    >
